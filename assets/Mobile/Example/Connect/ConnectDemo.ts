    ...
    */
    ...
    async adapterSignInWithEthereum() {
        ...
        if (result.status) {
            ...
            this._signInWithEthereumSourceMessage = message;
            const signature = result.data.signature;
            this._signInWithEthreumSignature = signature;
    ...
    async adapterVerify() {
        ...
        if (this._signInWithEthereumSourceMessage == '' || this._signInWithEthreumSignature == '' || this._signInWithEthereumSourceMessage == undefined || this._signInWithEthreumSignature == undefined) {
